    ...
    var MERGE_MODS = {
            ...
            define(function (require) {
                ...
                m = (function(){
                    ...
                    for(var o=0;o<j.length;o++){
                        code[j[o].varietyType]=j[o].contractsCode
                    }
                    return code;
                })(),
                i = {
                        ...
                        urlClose: "/order/order/unwind.do",
                        urlKline: "/quota/candlestickData/getCandlesticKData.do",
                        urlLogin: "../user/login.html",
                        urlOpen: "/order/order/submitOrder.do",
                        urlQuote: "/quota/quota/getQuotaDataAllByWeb.do",
                        urlScheme: "/order/order/getVarietyPositionOrders.do",
                        urlBalance:'/order/order/getVarietySettleOrders.do',
            ...
            define(function (require) {
                ...
                order = function(){
                    ...
                    k = setTimeout(function(){
                        a.get({
                            url:'/user/live/findFirstTeacherMsg.do',
                            data:{teacherId:teacherId},
                            success:function(d){
                                if(d.code==200){
                                    var msg = d.data.msg,
                                        now = (new Date()).getTime();
                                    if((orderId != msg.timeStamp)&&(now-msg.timeStamp<60000)){
                                        orderId = msg.timeStamp;
                                        r.attr('src',d.data.teacher.pictureUrl);
                                        s.text(msg.name+":"+msg.msg);
                                        u.addClass('order-curr');
                                        setTimeout(function(){
                                            u.removeClass('order-curr');
                                        },60000)
                                    }
                                    order();
                                }
                ...
                for(var i=0;i<_data.length;i++){
                    if(_data[i].varietyType.toUpperCase()==w.tradeComm){
                         w.futures=_data[i];
                    }
                }
                if(w.tradeType==2){
                    t('#summary>div>div').html('可用金币');
                    ...
                    t('#summary span.rechage').html('领取');
                }
               setTimeout(function(){
                    seajs.use("page/trade/quote",function(c){
                        ...
                        a.get({
                            ...
                            success:function(r){
                                if(r.data){
                                    w.isLogin = true;
                                    t('#summary em:eq(0)').text((w.tradeType=="2"?r.data.scoreUsable:r.data.moneyUsable));
                                }else{
                                    w.isLogin = false;
                                }
               ...
               a.get({
                    ...
                    success:function(d){
                        if(d.data.teacher){
                            teacherId  = d.data.teacher.teacherAccountId;
                             order();
                        }
                    }
               })
        ...
        "assets/js/biz/page/trade/base": function () {
            define(function (require) {
                ...
                t = require("dataStore"),
                i = t.get("config"),
                r = i.BASE ={commCode:i.futures.varietyType,scale:i.futures.marketPoint,commName:i.futures.varietyName,contCode:i.futures.contractsCode,volumeList:[],volumeCur:0,volumeShow:5,stopPlCur:0,stopProCur:0,stopPlShow:3,signed:false},
                a = i.base = {};
                i.tradeComm && e.extend(a, r)
            });
        },
                ...
                return {
                    ...
                    initElems: function () {
                        ...
                        this.elems = {
                            ...
                            stop_profit: t.eq(3).find("div.right"),
                            stop_loss: t.eq(2).find("div.right"),
                    ...
                    wait: function () {
                        ...
                        function (i) {
                            i.preventDefault();
                            var s = e(this);
                            s.hasClass("selected") || (s.siblings("span.lot.selected").removeClass("selected"), s.addClass("selected"), L.volume = s.data("value"), h.volumeCur = s.data("index"), t.updateServiceFee(), t.updateStopProfit(), t.updateStopLoss(), t.updateTradeCount(), t.updateDeposit(),t.updatePay())
                        ...
                        function (e) {
                            ...
                            var r=m.futures.rate;
                            t.menu.load(t.c2list(h.stopLossList, i,"",r)),
                            t.menu.show(function (e, i, s) {
                                h.stopPlCur = s.index,
                                h.stopProCur = 0,
                                t.updateTradeCount(),
                        ...
                        function (e) {
                            e.preventDefault();
                            var i = "1",
                            l=J1[h.stopPlCur].stopWinBeats,
                            K = [];
                            for(var j in l){
                                K.push(l[j]);
                            }
                            t.menu.load(t.c2list(K, i,'',1)),
                            t.menu.show(function (e, i, s) {
                        ...
                        function (o) {
                            ...
                            if (!n.hasClass("button-disabled")) {
                                var _data={};
                                _data.varietyId = m.futures.varietyId;
                                _data.assetsId=K.assetsId;
                                _data.handsNum=L.volume;
                                _data.payType=L.tradeType==1?1:0;
                                _data.direction=L.isBuy?1:0;
                                _data.orderPrice=L.price;
                                _data.stopWinBeat=L.stopProfit
                                var d = s.trigger_price.find("input"); (!d.eq(0).prop("checked") || (L.price = e.trim(d.eq(1).val()), L.price = "" === L.price ? 0 : L.price - 0, t.isValid())) && (n.addClass("button-disabled"), i.post({
                                    ...
                                    success: function (e) {
                                        ...
                                        function () {
                                            L.identity = a.get(16),
                                            (e.code==200||e.code==702)?(f.hide(), q.show(),r.notify("panelSwitch", "open-interest"),(e.code==702&&p.alert(e.msg))):p.alert(e.msg,function(){
                                                if(e.code==44007)window.location='../mine.html';
                                                if(e.code==503)window.location='../user/login.html';
                                            });
                                        });
                    ...
                    updateCash:function(){
                        i.get({
                            ...
                            data:{},
                            success:function(r){
                                e('#summary em:eq(0)').text((m.tradeType=="2"?r.data.scoreUsable:r.data.moneyUsable));
                    ...
                    updateView: function (e) {
                        var t = this.elems;
                        t.trade_goods.html("<em class='text-highs' style='font-size:14px;'>"+h.commName + " </em><em  style='font-size:12px;'> " + h.contCode + "</em>"),
                    ...
                    updateDeposit: function () {
                        ...
                        c = m.futures,
                        o = t*c.ratio,
                        i = '<span style="color:#666">'+c.sign + t.toFixed(2).replace(".00","") + "</span><em> (￥"+o+") </em>";
                        L.deposit = t
                    ...
                    updateServiceFee: function () {
                        ...
                        c = m.futures,
                        o = (h.chargeUnit* s).toFixed(2).replace(".00",""),
                        b = (o*c.ratio).toFixed(2).replace(".00","");
                        e = '<span style="color:#666">' +c.sign + o + "</span><em> (￥"+b+") </em>";
       
                        L.serviceCharge = parseFloat(b),
                        t.trade_fee.html(e)
                    },
                    updatePay:function(){
                        var c = m.futures,
                        a=L.deposit+(L.serviceCharge/c.ratio);
                            
                        this.elems.pay_sum.html('<em>('+c.sign+(a).toFixed(2).replace(".00","")+') </em><span class="text-stress text-m">￥'+(a*c.ratio).toFixed(2).replace(".00","")+'</span>');
                    },
                    updateCurrPrice: function () {
                        var e = _[h.contCode] || { 'wt_sale_price' : _bidPrice,'wt_buy_price':_askPrice},
                        t = L.isBuy ? e.wt_buy_price : e.wt_sale_price,
                        t =t&&t.toFixed(h.scale);
                        L.price=t;
                        this.elems.instant_buy.html("最新买入价<br><em class='text-highs text-m'>" + t + "</em>")
                    },
                    ...
                    updateCloseTime: function () {
                        ...
                        i.get({
                            ...
                            data: {
                                exchangeId: m.futures.exchangeId,
                                varietyType:h.contCode
                            },
                            success: function (i) {  
                                i.data.status&&_this.elems.close_time.html("<em>持仓至" + i.data.nextTime + "自动平仓</em>")//M.format(i.data.nextTime,'h:m')
                            },
                            error: function () {
                            }
                        })
                    ...
                    updateData:function(){
                         var _this=this;
                        i.get({
                            url:'/order/variety/getAssetsByVariety.do',
                            data:{varietyId:m.futures.varietyId,payType:m.tradeType==1?1:0},
                            success:function(d){
                                if(d.code!=200){
                                    p.alert(d.msg);
                                    return false;
                            ...
                            complete:function(){
                                ...
                                for(var i=0;i<J.length;i++){
                                    a.push(J[i].stopLossBeat);
                                    d.push(J[i].isDefault);
                                    c=J[i].fees;
                                    e.push(J[i].marginBeat);
                                    f.push(J[i].handsMultiple);
                                    J1.push(J[i]);
                                }
                                h.stopLossList=a;
                                h.chargeUnit=c;
                    ...
                    updateTradeCount: function () {
                        var _this=this;
                        var e = "",
                        x = h.handsMultiple[h.stopPlCur],
                        t = "";
                        e = '<span class="lot ${selected}" data-value="${lot}" data-index="${index}">${lot}手</span>',
                        h.volumeList= x,
                        h.volumeList.length<h.volumeCur?h.volumeCur=h.isDefault[h.stopPlCur]:!0,
                    ...
                    updateStopProfit: function () {
                        ...
                        b = [],
                        _fix=function(e){
                            return e.toFixed(String(e).indexOf('.') != -1 ? String(e).split('.')[1].substring(0,1) > 0 ? 2 : 0 : 0).replace(".00", "");
                        },
                        i = '<span class="trigger ${selected}" data-value="${price}" data-index="${index}">'+c.sign+'${price}</span>';
                        for(var c in t){
                            a.push(t[c]);
                            b.push(c);
                        }

                        h.stopProCur < 3 ? (a.forEach(function (s, n) {
                            n < 3&& (_html += o.format(i, {
                                price: _fix(s),
                                index: n,
                                selected: n === h.stopProCur ? "selected" : ""
                            }), n === h.stopProCur && (L.stopProfit = b[a.indexOf(s)]))
                        }), a.length > 3 && (_html += '<span class="more more-trigger iconfont icon-xiangxiajiantou"></span>')) : (_html += o.format(i, {
                            price: _fix(a[h.stopProCur]),
                            index: h.stopProCur,
                            selected: "selected"
                        }), L.stopProfit = b[h.stopProCur] , _html += '<span class="more more-trigger iconfont icon-xiangxiajiantou"></span>'),
                        this.elems.stop_profit.html(_html);
                        L.buyStopProfit=L.stopProfit;                    
                    ...
                    isValid: function () {
                        var e = _[h.contCode];
                        if (e.limit_down_price == 0 || e.limit_up_price == 0) {
                            return true;
                        } else {
        ...
        "data/contract/1.0/main": function () {
            define(function (require) {
                ...
                cl = [["05:59", "23:59"], ["00:00", "05:01"]],
                clT = [[["6:00", "9:00"], ["9:00", "11:00"], ["11:00", "13:00"]], [["13:00", "15:00"], ["15:00", "17:00"], ["17:00", "19:00"]], [["17:00", "20:00"], ["20:00", "22:00"], ["22:00", "24:00"]]
                    , [["22:00", "01:00"], ["01:00", "03:00"], ["03:00", "05:00"]]],
                cn = [["17:14", "23:59"], ["00:00", "02:01"], ["08:59", "16:36"]],
                cnT = [[["17:15", "20:00"], ["20:00", "22:00"], ["22:00", "24:00"], ["00:00", "02:00"]], [["09:00", "11:00"], ["11:00", "13:00"], ["13:00", "15:00"], ["15:00", "16:35"]]],
                hsi = [["17:14", "23:46"], ["09:14", "12:01"], ["13:00", "16:31"]],
                hsiT = [[["17:15", "19:00"], ["19:00", "21:00"], ["21:00", "22:00"], ["22:00", "23:45"]], [["09:15", "10:30"], ["10:30", "12:00"], ["13:00", "14:30"], ["14:30", "16:30"]]],
                mhi = [["17:14", "23:46"], ["09:14", "12:01"], ["13:00", "16:31"]],
                mhiT = [[["17:15", "19:00"], ["19:00", "21:00"], ["21:00", "22:00"], ["22:00", "23:45"]], [["09:15", "10:30"], ["10:30", "12:00"], ["13:00", "14:30"], ["14:30", "16:30"]]],
                dn = [["14:59", "23:59"], ["00:00", "05:01"]],
                dnT = [[ ["15:00", "17:00"], ["17:00", "19:00"]], [["19:00", "21:00"], ["21:00", "23:00"], ["23:00", "24:00"]]
                    , [["00:00", "02:00"], ["02:00", "03:00"], ["03:00", "05:00"]]],
                es =  [["05:59", "23:59"], ["00:00", "04:16"]],
                esT = [[["6:00", "9:00"], ["9:00", "11:00"], ["11:00", "13:00"]], [["13:00", "15:00"], ["15:00", "17:00"], ["17:00", "19:00"]], [["19:00", "21:00"], ["21:00", "23:00"], ["23:00", "24:00"]]
                    , [["00:00", "02:00"], ["02:00", "04:15"]]],
                l = {
                    IF: t,
                    IC: t,
                    IH: t,
                ...
                return {
                    ...
                    getTipsForNextTime: function (t) {
                        ...
                        a = new Date,
                        n = e.format(a, "h:m");
                        if(i[0][0] instanceof Array){
                             if (t === "CL"||t === "GC" || t === "DAX" || t === "ES" || t==="NQ" || t==="YM") {
                                i = i[0].slice().concat(i[0]);
                            }else{
                                i = i[1].slice().concat(i[0])
                            }
                        } 
            ...
            define(function (require) {
                ...
                return v.prototype = {
                    ...
                    setHeartbeat: function (t, e, h) {
                       ...
                       u.push(this._line(a, e, h, c, h, 'red',"3,3", m));
                       u.push(this._rect(a,c-l,h-7,0,l,15,'#4471BC',m));
                    ...
                    _drawPriceLine: function () {
                        ...
                        f = 0; p > f; f++) {
                            ...
                            E = C;
                            if(f==2|| f==4){
                                var aa = (t-_rangePrice*f).toFixed(this.scale);
                                 u.push(this._text(d, D, C+10, aa, "#888", "end", m))
                            }
                        ...
                        y = v.begin + 3,
                        V = "0.00%  "+s.toFixed(this.scale), s.toFixed(this.scale),
                        //u.push(this._text(d, y, w, V, "", "", m)),
                        //y = v.end - 3,
                       // V = "0.00%",
                ...
                return {
                    ...
                    querySlineData: function (t) {
                        ...
                        a = this.showLoading();
                         ...
                         i.ajax({
                            url: '/quotaStatus/'+d.commCode+'.fst',
                            dataType:'text',
                            type:'get',
                            data: {},
                            success: function (i) {
                     ...
                     beforeData:function(a,t){
                        ...
                        for(var i=0;i<b.length-1;i++){
                            var o='';
                            var j=b[i].split(',');
                            o=parseFloat(j[1]).toFixed(d.scale)+","+0+","+this.changeTime(j[2]);
                            c.push(o);  
                        }
                        var kk=c.join(';');
                    ...
                    changeTime:function(t){
                        return parseInt(t.substring(8,12));
                    },
        ...
        "assets/js/biz/mod/position": function () {
            define(function (require) {
                ...
                o = '<ul class="mod-list mod-list-std" data-index="${index}"><li class="clearfix"><div class="title"><h3 class="${buy_dir_css}">${buy_dir_txt}${volume}手</h3><h3 class="income ${income_css}">${income_txt}</h3></div></li><li class="clearfix"><div class="left">${placeholder2}</div><div class="right"><div class="status ${block_css}"><span>${block_txt}</span></div></div></li><li class="action ${errmsg_css}"><span class="text-lesser">${tradeMsg}</span></li></ul>',
                l = c.format(o, {
                    placeholder1: '<time class="right text-lesser">${time}</time>',
                    placeholder2: '<p class="text-lesser"><span>止盈 ${stopProfit}${currencyUnit}</span><span>${price1}</span></p><p class="text-lesser"><span>止损 ${stopLoss}${currencyUnit}</span><span>${price2}</span></p><p class="text-lesser">平仓时间： ${time}</p>'
                }),
                p = c.format(o, {
                    placeholder1: '<span style="display:none" class="right text-lesser do-set-spsl">设置止盈止损</span>',
                    placeholder2: '<p class="text-lesser"><span>止盈 ${stopProfit}${currencyUnit}</span><span>${price1}</span></p><p class="text-lesser"><span>止损 ${stopLoss}${currencyUnit}</span><span>${price2}</span></p>'
                }),
                n = c.format(o, {
                    placeholder1: '<time class="right text-lesser">${time}</time>',
                ...
                return {
                    ...
                    _render: function (s, r, o, l) {
                        ...
                        return s.forEach(function (s, d) {
                            ...
                            x = s.handsNum,
                            h = s.orderStatus,
                            v =  s.orderStatus==4?s.winOrLoss:(s.direction?((_bidPrice-s.realAvgPrice)*s.handsNum*s.eachPointMoney):((s.realAvgPrice-_askPrice)*s.handsNum*s.eachPointMoney))||0,
                            _ = i.scale,
                            $ = r[m] || {
                                price:  s.realAvgPrice/s.ratio
                            },
                            b = {
                                index: d,
                                time: t.format((s.orderStatus==4?s.sellTime:s.buyTime||s.orderTime), "y-M-D h:m:s"),
                                buy_dir_txt: s.direction ? "买涨" : "买跌",
                                buy_dir_css: s.direction ? "text-highs" : "text-lows",
                                income_txt: (s.orderStatus==2||s.orderStatus==4)?(v > 0 ? "+" : "") +_fix(v)+"("+_fix(v*s.ratio)+"元)":0,
                                income_css: v >= 0 ? "text-highs text-right" : "text-lows text-right",
                                jt_css:s.tradeType ? "jt-maizhang": "jt-maidie" ,
                                errmsg_css: s.tradeMsg ? "" : "hide",
                                status: s.orderStatus,
                                price2:s.orderStatus==4?'平仓 <em>' +(s.unwindAvgPrice).toFixed(_)+ "</em>":'现价 <em class="lastPrice">' +(s.direction ?(_bidPrice||0):(_askPrice||0))+ "</em>",
                            },
                            k = v;
                            s.buyPrice = s.realAvgPrice;
                            s.currencyName=w.futures.varietyName;
                            s.commodity=i.commName;
                            s.contract=i.contCode;
                            s.stopProfit = _fix(s.stopWinPrice);
                            s.stopLoss = _fix(s.stopLossPrice);
        ...
        "assets/js/biz/page/trade/open-interest": function () {
            define(function (require) {
                ...
                B = null,
                I = {
                    varietyId: b.futures.varietyId,
                    payType:b.tradeType==1?1:0
                },
                $ = i.get("urlScheme"),
                E = !0,
                P = !0,
                ...
                return {
                    ...
                    initElems: function () {
                        var t = g.find("div.summary").find("em");
                        this.$balance = t.eq(0),
                        this.$incomeSum = h.find('.sumIncome em'),
                        this.$incomeSumCny = h.find('.sumIncome span'),
                        this.$currency =  h.find("div.sumIncome .currency")
                    },
                    initData: function () {
                        var t = this;
                        //if (u.isLogin()) {
                    ...
                    wait: function () {
                        ...
                        function (e) {
                            ...
                            i = q[a],
                            o = i.isBuy ? "text-lows" : "text-highs",
                            s = i.isBuy ? "买跌" : "买涨",
                    ...
                    showSum:function(t){
                        ...
                        t.forEach(function(t){
                            (t.orderStatus==2||t.orderStatus==3)&&n++;
                        });
                    ...
                    calcIncome: function () {
                        ...
                        q.forEach(function (a, i) {
                            //a.buyPrice = a.realAvgPrice/a.ratio;
                            a.buyPrice = a.realAvgPrice;
                             var s = B[b.base.contCode] || {
                                price: a.direction ? a.buyPrice : a.salePrice
                            },
                            f = 0,
                            c = 0;
                             ...
                             var d, r = C,_price,
                            _ = r.scale,
                            l = b.futures.eachPointMoney;
                            d = !a.buyPrice ? 0 :(a.direction ? _bidPrice- a.buyPrice : a.buyPrice - (a.salePrice || _askPrice )),
                            f += l * a.handsNum * d,
                            c +=  f* a.ratio,
                            n += c,
                            _price = a.direction ? _bidPrice:_askPrice;
                            t.updateIncome(r, e, i, c,_price,f);

                        });
                        this.updateIncomeSum(n)
                    },

                    updateIncome: function (t, e, n, a,p,f) {
                        ...
                        if (i[0]) {
                            var o = a >= 0 ? "text-highs text-right" : "text-lows text-right",
                            //a=a/b.futures.rate,
                            s = (f > 0 ? "+" : "") +_fix(f)+"("+_fix(f*b.futures.ratio)+"元)";
                            i[0].className = "income " + o,
                            i.text(s),
                            k.text(p.toFixed(t.scale))
                        }
                    ...
                    updateIncomeSum: function (t) {
                        if (this.$incomeSum[0]) {
                            ...
                            n = (t > 0 ? "+" : "") +(t/b.futures.ratio).toFixed(2).replace(".00", "");
                            this.$incomeSum.attr('class',e),
                            this.$incomeSum.text(n),
                            this.$incomeSumCny.text("("+t.toFixed(2).replace(".00", "")+"元)"),
                            this.$currency.text(b.futures.currencyUnit)
                        }
                    },
                ...
                return {
                    ...
                    initElems: function () {
                        ...
                        this.elems = {
                            ...
                            quote_trade_tips: t.children("ul").eq(1),
                            quote_change_tips: t.children("ul").eq(2),
                    ...
                    initData: function () {
                        ...
                        e.title.text(v.tradeType==1?'实盘交易':'金币模拟'),
                    ...
                    initMenu: function () {
                       ...
                       j.forEach(function (t) {
                            var _url=t.isDomestic?'../trade/index.html?commodity='+t.varietyType.toUpperCase():'../guoji/index.html?commodity='+t.varietyType;
                                 e.push({
                                    name: t.varietyName,
                                    value: t.contractsCode,
                                    code: t.varietyType.toUpperCase(),
                                    url:_url
                                })
                           
                        });
                        2 === v.tradeType && e.push({
                            name: "【去实盘交易】",
                            value: "REAL_TRADE",
                            code: ""
                        }),
                    ...
                    wait: function () {
                        ...
                        function (e) {
                            ...
                            t.menuContract.show(function (e, i, a) {
                                ...
                                //return "REAL_TRADE" === i ? void (window.location.href = "index?tradeType=1&commodity=" + t.getRealTradeCommCode() + "&back") : (document.title = e + C, r.isLogin() && g !== i && l.notify("switchToPanel", "make"), void l.notify("changePageHash", a.code))
                            })
                        }),
                       
                        _.find("a.button-buy-highs, a.button-buy-lows").on("tap",
                        function (t) {
                            require('page/trade/option');
                        ...
                        function (t) {
                            window.location='/activity/'+w.commCode+'TradeRule.html?mobi=mobi';
                    ...
                    queryQuoteData: function () {
                        ...
                        x = function (i) {
                            ...
                            i = b(i),
                            e.showCloseTips(),
                            (i || Q)&&y?h(): t = s.one(x).id
                        },
                        socket = function(c){
                            var ws = ['ws://139.224.3.81:3009/quota/getQuotaByCode.do'],
                            websocket;
                            if ('WebSocket' in window) {
                                websocket = new WebSocket(ws[0]);
                            } else if ('MozWebSocket' in window) {
                                websocket = new MozWebSocket(ws[0]);
                            } else {
                                websocket = new SockJS(ws[0]);
                            }
                    ...
                    updateCloseTime: function () {
                        ...
                        a.get({
                            url: '/order/order/getTradeTime.do',
                            data: {
                                exchangeId: v.futures.exchangeId,
                                varietyType:v.futures.contractsCode
                            },
                            success: function (i) {  
                                i.data.status&&e.closeTime.html("<span class='text-minor'>本时段持仓时间至 <em class='text-highs'>" + i.data.nextTime  + "</em></span>")//M.format(i.data.nextTime,'h:m')
                            },
                            error: function () {
                            }
                        })
                    ...
                    processSettle: function (e, t, i) {
                        ...
                        t.text(i.toFixed(w.scale)).removeClass(n).addClass(o)
                    },
                    ...
                    queryKlineData: function (t) {
                        ...
                        a = this.showLoading();
                         ...
                         i.ajax({
                            ...
                            dataType:'json',
                            type:'post',
                            data: {contractsCode:t},
                            success: function (i) {
                                n.hideLoading(a),
                                i ? n.beforeData(i.data, t) : e.error("查询分时图数据失败")
                            },
                            error: function (t, i) {
                                n.hideLoading(a),
                                e.error("分时接口异常", i)
                     ...
                     beforeData:function(k,t){
                        ...
                        for(var i=0;i<k.length;i++){
                            var o='';
                            o+=k[i].openPrice+","+k[i].maxPrice+","+k[i].minPrice+","+k[i].closePrice+","+k[i].closePrice+","+k[i].nowVolume+","+0+","+0+","+k[i].day.replace(/-/g,'');
                            arr.push(o);
                        }
            ...
            define(function (require) {
                ...
                return {
                    ...
                    saleOne: function (e, a, o) {
                        ...
                        var n = j,
                        r = {
                            payType:g.tradeType==1?1:0,
                            showId: e.showId,
                            unwindPrice: (e.direction ?_bidPrice:_askPrice)
                        },
                        l = "reverse" === a;
                    ...
                    saleAll: function (t) {
                        ...
                        d = 0,
                        c = "<div>【卖出委托正在提交中】</div>",
                        u = "<div>【卖出委托提交完毕】</div><div>${total}</div>",
                        p = function (m) {
                            var i = {
                                total: m
                                // done: r,
                        ...
                        v = function (t) {
                            ...
                            t.forEach(function(r){
                                if(r.orderStatus==2){
                                    s.push(r.showId);
                                    p.push(r.direction?_bidPrice:_askPrice);
                                }
                    ...
                    updateViewForSoldAll: function (t) {
                        ...
                        m.forEach(function (t) {
                           (2 === t.orderStatus) && (_++, t.direction ? w++: b++ )
                        }),
                    ...
                    queryData: function (t) {
                        ...
                        n.get({
                            ...
                            success: function (n) {
                                d.done(n,
                                function () {
                                     n.code==200 ? (e.processData(n.data.data, t,D.pageNo), e.updateBalance(n), e.addGetMore(n)) : a.error("获取结算数据失败")
                                })
                            },
                            complete: function () {
