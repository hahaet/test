(function () {
    var MERGE_MODS = {
        ...
        "assets/js/biz/page/mine/done": function () {
            define(function (require) {
                "use strict";
                var e = require("modLoader");
                e({
                    "section.main-mine-funds": "page/mine/funds",
                    "section.mine-profile-auth": "page/mine/profile-auth",
                    "section.mine-profile-card-add": "page/mine/profile-card-add",
                    "section.mine-profile-card-upd": "page/mine/profile-card-upd",
                    "section.mine-profile-mobile": "page/mine/profile-mobile",
                    "section.mine-profile-loginpass": "page/mine/profile-loginpass",
                    "section.mine-profile-atmpass": "page/mine/profile-atmpass",
                    "section.mine-profile-findbackpaypwd": "page/mine/findbackpaypwd",
                    "section.mine-spread-home": "page/mine/spread",
                    "section.mine-spread-user": "page/mine/spread-user",
                    "section.mine-employee-user": "page/mine/employee-user"
                })
            });
        },
        "assets/js/biz/page/mine/doneCenter": function () {
            define(function (require) {
                "use strict";
                var e = require("modLoader");
                e([require("page/mine/center")]);
            });
        },
        ...
        "assets/js/ui/loading/1.0/main": function () {
            define(function (require) {
                ...
                var i = require("$"),
                n = i("#doc"),
                d = '<div class="loading hide"><div class="content"></div></div>',
                s = 0,
                e = null,
                t = function () {
                    if (!e) {
        ...
        "assets/js/biz/page/mine/center": function () {
             define(function (require) {
                "use strict";
                var e = require("$"),
                ...
                l = require("mod/ajax-result"),
                f =require("ui/msgbox"),
                w = require("assets/js/lang/cookie"),
                k =require("ui/loading"),
                d = n.get("urlDetails"),
                o = e('#accounts'),
                c = e('.mine-mod-list .goCash'),
                b = e('.goDetail'),
                u = e('#doc'),
                m = o.find('.user a'),
                h = u.find("header.page-header"),
                j = h.find('div.right a'),
                p = m.find('span:eq(1)'),
                q= o.find('.detail'), 
                r = q.find('em'),
                s = o.find('.action'),
                ...
                return {
                    ...
                    queryDetails:function(){
                        ...
                        t.get({
                            ...
                            success: function (t) {
                                if(t.code==200){
                                    p.text('您好，'+t.data.userName);
                                    r.eq(0).text(parseFloat(t.data.moneyUsable).toFixed(2));
                                    r.eq(1).text(t.data.scoreUsable);
                                    s.eq(1).show();
                                    j.show();
                                    w.setItem('ut',t.data.userPhone);
                                }else{
                                    s.eq(0).show();
                                    if(t.code==503){isLogin=false}
                                }
                    ...
                    Promoter : function(){
                        var Atuig = e('#tuig'),
                            Aalert1 = e('#alert1'),
                            AbtnL = Aalert1.find('.btnL'),
                            AbtnR = Aalert1.find('.btnR');
                        Atuig.on('click',function(){
                            if(!isLogin){
                                window.location = '../user/login.html';
                                return false;
                            }
                            e.ajax({
                                ...
                                success:function(d){
                                    if(d.data){
                                        ...
                                        Aalert1.show();
                                        AbtnL.on('tap',function(e){
                                            e.preventDefault();
                                            becomePro();
                                        });
                                        AbtnR.on('tap',function(e){
                                            e.preventDefault();
                                            Aalert1.hide();
                                            return;
                                        });
        ...
        "assets/js/biz/page/mine/funds": function () {
            define(function (require) {
                "use strict";
                var e = require("$"),
                t = (require("log"), require("net")),
                ...
                s = require("util/numbers"),
                l = require("mod/ajax-result"),
                o = require("ui/menu").SlideDown,
                d = n.get("urlQuery"),
                u = 0,
                r = "",
                f = !1,
                m = '<li><a href="#" class="clearfix"><span class="left"><span class="text-minor">${explain}</span><br><time class="text-lesser">${time}</time></span><span class="right ${type}">${money}</span></a></li>', //fa_detail?id=${id}
                c = e("#doc"),
                p = c.find("header.page-header"),
                h = c.find("section.main-mine-funds");
                return {
                    init: function () {
                        this.initMenu(),
                        this.wait()
                    ...
                    wait: function () {
                        {
                            var t = this;
                            h.find("div.dropdown-list")
                        }
                        p.find("h3 > span").on("tap",
                        function (n) {
                            n.preventDefault();
                            var i = e(this);
                            t.menuFilter.show(function (e, n) {
                                i.children("em").text(e),
                                u = n,
                                r = "",
                                f = !0,
                                t.queryDetails()
                        ...
                        h.find("div.more > a").on("tap",
                        function (n) {
                            n.preventDefault(),
                            e(this).hasClass("button-disabled") || (r = r || e(this).data("value"), f = !1, t.queryDetails())
                        })
                    },
                    queryDetails: function () {
                        var e = this,
                        ...
                        t.get({
                            ...
                            success: function (t) {
                                l.done(t,
                                function () {
                                    t.success && e.processData(t.data, t.pageCount)
                                })
                            },
                            complete: function () {
                    ...
                    processData: function (e, t) {
                        var n = this,
                        s = h.find("ul.mod-list"),
                        l = "";
                        e.forEach(function (e) {
                            l += i.format(m, {
                                id: e.id,
                                explain: e.explain,
                                time: a.format(e.time, "y-M-D h:m:s"),
                                money: n.fmtMoney(e.money, e.type),
                                type: e.money >= 0 ? "text-highs" : "text-lows"
                            })
                        }),
                        f && s.empty(),
                        s.append(l).toggleClass("hide", 0 === s.children("li").length),
                        e.length && (r = e[e.length - 1].id),
                        h.find("div.more").toggleClass("hide", e.length < t)
                    },
                    fmtMoney: function (e, t) {
                        var n = e > 0 ? "+" : "",
                        i = e.toFixed(2),
                        a = i.substring(i.indexOf(".")),
                        l = n + s.format(0 | e);
                        return '<span class="text-l">' + l + "</span>" + a
                    }
                }
            });
        },
        "assets/js/biz/page/mine/profile-atmpass": function () {
            define(function (require) {
                "use strict";
                var t = require("$"),
                ...
                n = require("ui/msgbox"),
                r = t("#doc"),
                w = r.find("section.mine-profile-atmpass"),
                d = a.get("urlSave");
                return {
                    init: function () {
                        this.wait()
                    ...
                    wait: function () {
                        var t = this;
                        w.find("div.action a.button").on("tap",
                        function (a) {
                            a.preventDefault();
                            var n = t.getParams();
                            t.isValid(n) && i.ajax({
                    ...
                    getParams: function () {
                        return {
                            password: t.trim(w.find("input.password").val()),
                            withdrawPw: t.trim(w.find("input.withdrawPw").val()),
                            withdrawPwCfm: t.trim(w.find("input.withdrawPwCfm").val())
                        }
                    },
                    isValid: function (t) {
                        var msg = w.find("input.password").attr("placeholder");
                        return t.password ? t.withdrawPw ? t.withdrawPwCfm ? !0 : (n.alert("请确认提款密码"), !1) : (n.alert("请输入提款密码"), !1) : (n.alert(msg), !1)
                    }
                }
            });
        },
        "assets/js/biz/page/mine/profile-auth": function () {
            define(function (require) {
                "use strict";
                var t = require("$"),
                i = require("net"),
                ...
                e = n.get("urlSave"),
                u = t("#doc"),
                r = u.find("section.mine-profile-auth");
                return {
                    init: function () {
                        this.wait()
                    },
                    wait: function () {
                        var i = this;
                        r.find("div.action a.button").on("tap",
                        function (n) {
                            n.preventDefault();
                            var a = t(this);
                            a.hasClass("button-disabled") || i.isValid() && i.doAuth(a)
                        })
                    },
                    doAuth: function (t) {
                    ...
                    getParams: function () {
                        return {
                            name: t.trim(r.find('input[name="name"]').val()),
                            identityNumber: t.trim(r.find('input[name="identityNumber"]').val())
                        }
                    },
                    isValid: function () {
                        var t = this.getParams();
                        return t.name ? t.identityNumber ? !0 : (a.alert("请输入身份证号"), !1) : (a.alert("请输入真实姓名"), !1)
                    }
                }
            });
        },
        ...
        "data/address/1.0/province": function () {
            define(function () {
                var n = {
                    "A-G": [["340000", ["安徽", "安徽"], "1"], ["820000", ["澳门特别行政区", "澳门特别行政区"], "1"], ["110000", ["北京", "北京"], "1"], ["500000", ["重庆", "重慶"], "1"], ["350000", ["福建", "福建"], "1"], ["620000", ["甘肃", "甘肅"], "1"], ["440000", ["广东", "廣東"], "1"], ["450000", ["广西", "廣西"], "1"], ["520000", ["贵州", "貴州"], "1"]],
        ...
        "assets/js/ui/address/1.0/main": function () {
            define(function (require) {
                ...
                return {
                    ...
                    getProvinceCode: function (n) {
                        var r, e = this.getProvinces();
        ...
        "assets/js/biz/page/mine/profile-card-add": function () {
            define(function (require) {
                "use strict";
                var e = require("$"),
                t = (require("log"), require("net")),
                ...
                i = require("ui/msgbox"),
                o = require("ui/menu"),
                s = require("ui/address"),
                r = n.get("urlSave"),
                c = e("#doc"),
                l = c.find("section.mine-profile-card-add");
                return {
                    init: function () {
                        this.initMenu(),
                        this.wait()
                    ...
                    initMenu: function () {
                        var e = l.find("label.choose-bank").parent().data("source"),
                        t = a.parse(e).data,
                        n = s.getProvinces();
                        this.menuBank = new o(t),
                        this.menuProvince = new o(n),
                        this.menuCity = new o([])
                    },
                    wait: function () {
                        var n = this;
                        l.find("label.choose-bank").parent().on("tap",
                        function (e) {
                            e.preventDefault(),
                            n.menuBank.show(function (e) {
                                n.chooseBank(e)
                            })
                        }),
                        l.find("label.choose-province").parent().on("tap",
                        function (e) {
                            e.preventDefault(),
                            n.menuProvince.show(function (e, t) {
                                n.chooseProvince(e);
                                var a = s.getCitys(t + "");
                                n.menuCity.load(a),
                                n.chooseCity()
                        ...
                        l.find("label.choose-city").parent().on("tap",
                        function (e) {
                            e.preventDefault(),
                            n.menuCity.show(function (e) {
                                n.chooseCity(e)
                            })
                        }),
                        l.find("div.action a.button").on("tap",
                        function (a) {
                            a.preventDefault();
                            var i = e(this);
                            if (!i.hasClass("button-disabled")) {
                                var o = n.getParams();
                                n.isValid(o) && (i.addClass("button-disabled"), t.ajax({
                                    url: r,
                                    data: o,
                                    complete: function () {
                                        i.removeClass("button-disabled")
                                    }
                                }))
                            }
                        })
                    ...
                    getParams: function () {
                        return {
                            bank: l.find("label.choose-bank > span.title").text(),
                            province: l.find("label.choose-province > span.title").text(),
                            city: l.find("label.choose-city > span.title").text(),
                            subbranch: e.trim(l.find("input.subbranch").val()),
                            cardNumber: e.trim(l.find("input.cardNumber").val()),
                            cardNumberCfm: e.trim(l.find("input.cardNumberCfm").val())
                        }
                    },
                    isValid: function (e) {
                        var t = e.bank;
                        return "" === t || -1 !== t.indexOf("请选择") ? (i.alert("请选择开户银行"), !1) : (t = e.province, "" === t || -1 !== t.indexOf("请选择") ? (i.alert("请选择省"), !1) : (t = e.city, "" === t || -1 !== t.indexOf("请选择") ? (i.alert("请选择市"), !1) : (t = e.cardNumber, "" === t ? (i.alert("请输入银行卡号"), !1) : (t = e.cardNumberCfm, "" === t ? (i.alert("请确认银行卡号"), !1) : !0))))
                    },
                    chooseBank: function (e) {
                        var t = l.find("label.choose-bank > span.title");
                        t.text(e).removeClass("text-lesser")
                    },
                    chooseProvince: function (e) {
                        var t = l.find("label.choose-province > span.title");
                        t.text(e).removeClass("text-lesser")
                    },
                    chooseCity: function (e) {
                        var t = l.find("label.choose-city > span.title");
                        e ? t.text(e).removeClass("text-lesser") : t.text("请选择市").addClass("text-lesser")
                    }
                }
            });
        },
        "assets/js/biz/page/mine/profile-card-upd": function () {
            define(function (require) {
                "use strict";
                var t = require("$"),
                e = require("net"),
                ...
                n = require("ui/msgbox"),
                a = require("ui/menu"),
                o = require("ui/address"),
                s = i.get("urlSave"),
                r = i.get("urlDef"),
                c = i.get("urlDel"),
                d = i.get("config"),
                u = t("#doc"),
                l = u.find("section.mine-profile-card-upd");
                return {
                    init: function () {
                        this.initMenu(),
                        this.wait()
                    ...
                    initMenu: function () {
                        var t = this.getParams(),
                        e = o.getProvinceCode(t.province),
                        i = o.getProvinces(),
                        n = o.getCitys(e);
                        this.menuProvince = new a(i),
                        this.menuCity = new a(n)
                    },
                    wait: function () {
                        var i = this;
                        l.find("label.choose-province").parent().on("tap",
                        function (t) {
                            t.preventDefault(),
                            i.menuProvince.show(function (t, e) {
                                i.chooseProvince(t);
                                var n = o.getCitys(e + "");
                                i.menuCity.load(n),
                                i.chooseCity()
                        ...
                        function (t) {
                            t.preventDefault(),
                            i.menuCity.show(function (t) {
                                i.chooseCity(t)
                            })
                        }),
                        l.find("div.action a.do-modify").on("tap",
                        function (n) {
                            n.preventDefault();
                            var a = t(this);
                            if (!a.hasClass("button-disabled")) {
                                var o = i.getParams();
                                i.isValid(o) && (a.addClass("button-disabled"), e.ajax({
                                    url: s,
                                    data: o,
                                    complete: function () {
                        ...
                        l.find("div.action a.do-set-def").on("tap",
                        function (t) {
                            t.preventDefault(),
                            e.ajax({
                                url: r,
                        ...
                        l.find("div.action a.do-delete").on("tap",
                        function (t) {
                            t.preventDefault(),
                            n.confirm("您确定要删除该银行卡吗?",
                            function () {
                                e.ajax({
                                    url: c,
                                    data: {
                    ...
                    getParams: function () {
                        return {
                            ...
                            province: l.find("label.choose-province > span.title").text(),
                            city: l.find("label.choose-city > span.title").text(),
                            subbranch: t.trim(l.find("input.subbranch").val())
                        }
                    },
                    isValid: function (t) {
                        var e;
                        return e = t.province,
                        "" === e || -1 !== e.indexOf("请选择") ? (n.alert("请选择省"), !1) : (e = t.city, "" === e || -1 !== e.indexOf("请选择") ? (n.alert("请选择市"), !1) : !0)
                    },
                    chooseProvince: function (t) {
                        var e = l.find("label.choose-province > span.title");
                        e.text(t).removeClass("text-lesser")
                    },
                    chooseCity: function (t) {
                        var e = l.find("label.choose-city > span.title");
                        t ? e.text(t).removeClass("text-lesser") : e.text("请选择市").addClass("text-lesser")
                    }
                }
            });
        },
        "assets/js/biz/page/mine/profile-loginpass": function () {
            define(function (require) {
                "use strict";
                var n = require("$"),
                ...
                i = require("ui/msgbox"),
                e = n("#doc"),
                s = e.find("section.mine-profile-loginpass"),
                r = t.get("urlSave");
                return {
                    init: function () {
                        this.wait()
                    ...
                    getParams: function () {
                        return {
                            oldPass: n.trim(s.find('input[name="oldPass"]').val()),
                            newPass: n.trim(s.find('input[name="newPass"]').val()),
                            newPassCfm: n.trim(s.find('input[name="newPassCfm"]').val())
                        }
                    },
                    isValid: function (n) {
                        return n.oldPass ? n.newPass ? n.newPassCfm ? !0 : (i.alert("请确认新密码"), !1) : (i.alert("请输入新密码"), !1) : (i.alert("请输入旧密码"), !1)
                    }
                }
            });
        },
        "assets/js/biz/mod/sms": function () {
            define(function (require) {
                ...
                a = n.get("urlSendCode"),
                w = require("assets/js/lang/cookie"),
                u = '/user/user/checkRetriveMsgCode.do';
                ...
                return {
                    ...
                    verify: function (n, mobile) {
                        e.ajax({
                            ...
                            success:function(e){
                                if(e.code==200){
                                    w.setCookie('tele',mobile);
                                    e.redirectUrl='../user/resetPwd.html';
                                }
            ...
            define(function (require) {
                ...
                return {
                    ...
                    wait: function () {
                        ...
                        t('body').on('click','.img-code-view',function(){
                            $(this).attr('src','/user/user/getRetrieveImage.do?userPhone='+u.val()+'&_='+(new Date()).getTime());
                        }),
                        s.on("tap",
                        function (a) {
                            a.preventDefault();
                            ...
                            if (u.blur(), !e.hasClass("button-disabled")) {
                                ...
                                if (o) {
                                    ...
                                    var l = '<div style="margin-bottom:0.06rem;">请输入验证码</div><div><img class="img-code-view" src="/user/user/getRetrieveImage.do?userPhone='+o+'&_='+(new Date()).getTime()+'" style="width:0.8rem;vertical-align:middle;"><input type="text" class="input img-code-input" maxlength="4" style="width:0.8rem;text-align:center;border-radius:0;border:1px solid #ddd"></div>';
                                    i.confirm(l,
                                    function () {
                                        var v = t('.img-code-input').val();
                                        d.send(s, o,v,
                                        function () {
                                            n.countdown(e)
                                        })
                        ...
                        function (i) {
                            ...
                            if (l.blur(), !n.hasClass("button-disabled")) {
                                var e = t.trim(l.val());
                                d.verify(e,mobile);
                            }
                        })
                    ...
                    isValid: function () {
                        ...
                        return o[0] && (s = o.prop("checked")),
                            n && /\d{11}/.test(n) && e && /\d{4}/.test(e) && s && (picVcode.length === 4 || !picVcodeInput.length);
                    }
                }
            });
        },
         
        "assets/js/biz/page/mine/findbackpaypwd": function () {
            define(function (require) {
                "use strict";
                var t = require("$"),
                i = (require("net"), require("dataStore"), require("ui/msgbox")),
                ...
                return {
                    ...
                    wait: function () {
                        ...
                        function () {
                            ...
                            e && /\d{11}/.test(i) && (picVcode.length === 4 || !picVcodeInput.length) ? s.removeClass("disabled button-disabled") : s.addClass("disabled button-disabled"),
                            n.isValid() ? o.removeClass("button-disabled") : o.addClass("button-disabled")
                        }),
                        l.on("keyup",
                        function () {
                        ...
                        function (a) {
                            ...
                            if (u.blur(), !e.hasClass("button-disabled")) {
                                ...
                                o = t.trim(u.val()),
                                picVcode = t.trim(picVcodeInput.val());
                                if (o && picVcode.length === 4) {
                                    var mobileString = $("#mobileStr").val();
                                    var l = "<div>短信验证码将发送到</div><div>" + mobileString + "</div>";
                                    i.confirm(l,
                                    function () {
                                        d.send(s, o, picVcode,
                                        function () {
                        ...
                        function (i) {
                            ...
                            var n = t(this),
                                ...
                                mobile = t.trim(u.data("value") || u.val()),
                            a = n.data("value");
        ...
        "assets/js/biz/page/mine/profile-mobile": function () {
            define(function (require) {
                "use strict";
                require("mod/smscode").init()
            });
        },
        "assets/js/biz/page/mine/spread-user": function () {
            define(function (require) {
                "use strict";
                var _t = this,
                    j = require("$"),
                    t = require("net"),
                    a = require("dataStore"),
                    s = require("util/strings"),
                    i = require("util/dates"),
                    n = require("mod/ajax-result"),
                    r = a.get("urlQuery"),
                    o = "",
                    u = '<li class="clearfix"><span class="left">${username}</span><span class="right">${tradeVolume}</span></li>',
                    l = j("#doc"),
                    d = l.find("section.mine-spread-user"),
                    u = j(d).find('ul.mod-list'),
                    pageNo = 0;
                return {
                    init: function () {
                        this.wait()
                    ...
                    queryMore: function (e) {
                        var _this = this;
                        j.ajax({
                            url: '/user/user/qureypagingSonUser.do',
                            data: {page : pageNo,pageSize:10},
                            dataType: 'json',
                            type: 'post',
                            success: function (e) {
                                j.each(e.data.data, function (index, element) {
                                    u.append(j('<li class="clearfix"><span class="left">'+element.userName+'</span><span>'+element.totalHandsNum+'</span><span class="right">'+i.format(element.registerTime, "Y-M-D h:m")+'</span></li>'));
                                });
                                if(j("#getMore")){
                                    j("#getMore").remove();
                                }
                                if(e.data.data.length >= 10){
                                    u.after('<a class=" button button-buy-lows more" id="getMore">点击加载更多</a>');
                                    d.find('#getMore').on("tap", function (a) {
                                        a.preventDefault();
                                        var s = j(this);
                                        pageNo++;
                                        s.hasClass("button-disabled") || (o = o || j(this).data("value"), _this.queryMore(s))
                                    });
                                }
                            }
                        });
                    ...
                    processData: function (e, t) {
                        ...
                        if (e.forEach(function (e) {
                            e.registerTime = i.format(e.registerTime, "Y-M-D"),
                            a += s.format(u, e)
                        }), e.length) {
                            var n = e[e.length - 1];
                            o = i.format(n.registerTime, "Y-M-D h:m")
                        }
                        e.length < t && d.find("a.get-more").addClass("hide"),
                        d.find("ul.mod-list").append(a)
                    }
                }
            });
        },
        "assets/js/biz/page/mine/employee-user": function () {
            define(function (require) {
                "use strict";
                var e = require("$"),
                t = require("net"),
                ...
                r = a.get("urlQuery"),
                o = "",
                u = '<li class="clearfix"><a href="/daren/profile?id=${userid}"><span class="left" style="width:350px;">${username}</span><span class="right" style="margin-top:-7px;">交易手数:${tradeVolume}手</span><div style="clear:both"></div><span style="display:block">注册时间:${registerTime}</span></a></li>',
                l = e("#doc"),
                d = l.find("section.mine-employee-user");
                return {
                    init: function () {
                        this.wait()
                    },
                    wait: function () {
                        var t = this;
                        d.find("a.get-more").on("tap",
                        function (a) {
                            a.preventDefault();
                            var s = e(this);
                            s.hasClass("button-disabled") || (o = o || e(this).data("value"), t.queryMore(s))
                        })
                    },
                    queryMore: function (e) {
                        var a = this;
                        ...
                        t.get({
                            ...
                            success: function (e) {
                                n.done(e,
                                function () {
                                    a.processData(e.data, e.pageCount)
                                })
                            },
                            complete: function () {
                    ...
                    processData: function (e, t) {
                        ...
                        if (e.forEach(function (e) {
                            ...
                            var n = e[e.length - 1];
                            o = i.format(n.registerTime, "Y-M-D h:m:s")
                        }
                        e.length < t && d.find("a.get-more").addClass("hide"),
                        d.find("ul.mod-list").append(a)
                    }
        ...
        "assets/js/biz/page/mine/spread": function () {
            define(function (require) {
                "use strict";
                var t = require("$"),
                n = require("net"),
                e = require("dataStore"),
                i = require("util/numbers"),
                a = require("util/clipboard"),
                o = require("ui/msgbox"),
                r = e.get("urlExchange"),
                d = t("#doc"),
                s = d.find("section.mine-spread-home");
                return {
                    init: function () {
                        this.wait();
                        this.Offline()
                    ...
                    wait: function () {
                        ...
                        function (e) {
                            ...
                            if (0 >= ktyj){
                                ...
                                if (a.hasClass("button-disabled")) return;
                                var d = "您的佣金账户余额为：" + i.money(ktyj) + '元，确定转入余额账户吗？';
                                o.confirm(d,
                                function () {
                                    n.doExchange(a, ktyj);
                                ...
                                o.alert("佣金余额大于100元方可提现！");
                            }
                        }),
                        s.find("div.share div.qrcode img").on("tap",
                        function (n) {
                            n.preventDefault();
                            var e = d.find("div.big-qrcode"),
                            i = e.find("img");
                            i.attr("src") || (i.attr("src", t(this).attr("src")), i.next().text("扫一扫，推广赚钱")),
                            e.show()
                        }),
                        d.find("div.big-qrcode").on("tap",
                        function (n) {
                            n.preventDefault(),
                            t(this).hide()
                        }),
                        s.find("span.copy").on("tap",
                        function (n) {
                            n.preventDefault();
                            var e = a.copy(t(this).prev()[0]);
                            o.toast(e ? "复制成功，马上推广吧" : "请长按推广链接进行复制")
                        })
                    },
                    doExchange: function (t, e) {
                        t.addClass("button-disabled"),
                        n.ajax({
                            url: "/user/finance/withdrawCommission.do",
                            data: { money : e},
                            success:function(d){
                                o.alert(d.msg,function(){
                    ...
                    Offline : function(){
                        t.ajax({
                            ...
                            success: function (data) {
                                if(data.code == 200) {
                                    var newLink = "http://"+ window.location.host + '/?abc=' + data.data;
                                    t("#extensionLink").val(newLink);
                                    t("#extensionLink").attr("value",newLink);
                                    var img="http://qr.liantu.com/api.php?text="+newLink;
                                    t("#qrcode").html("<img src='"+img+"'/>");
                                }
                            }
                        });
                         t.ajax({
                            url: '/order/promoter/getCurrentCom.do',
                            data: {},
                            dataType: 'json',
                            type: 'post',
                            success: function (data) {
                                if(data.code == 200) {
                                    t('#ktjy').text(data.data.currentCom);
                                    t('#myUser').text(data.data.myUsersCount);
                                    t('#trader').text(data.data.dealUsersCount);
                                }
                            }
                        });
                         t.ajax({
                            url: '/user/user/findPromoterLevel.do',
                            data: {},
                            dataType: 'json',
                            type: 'post',
                            success: function (data) {
                                if(data.code == 200) {
                                    t('#myLevel').text(data.data);
                                }
                            }
                        });
                         t.ajax({
                            url: '/user/user/getLevelsForUser.do',
                            data: {},
                            dataType: 'json',
                            type: 'post',
                            success: function (data) {
                                if(data.code == 200) {
                                   ...
                                   for(var i=0;i<data.data.length;i++){
                                        trs+='<tr><td class="color">'+data.data[i].levelName+'</td><td>'+data.data[i].advertisement+'</td></tr>';
                                   }
                                   t('#levels').html(trs);
                                }
                            }
